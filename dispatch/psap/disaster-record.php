...
$_SESSION['disaster1_id'] = $print_output['disaster_id']; 

echo "<br><br><br><br><br><br>";

echo "HEELLOO";//$_SESSION['disaster1_id'];
...
$event_date = date("Y-m-d H", strtotime($print_output['date_time'])); // Converts disaster date_time to date ONLY
