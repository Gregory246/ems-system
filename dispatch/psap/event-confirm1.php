...
<fieldset style = "display:inline-block; vertical-align:left">
  <legend style= "color:red"><strong>Disaster Details:</strong></legend>
...
<!--  --------------------Caller Details---------------------------  -->
      <fieldset style = "display:inline-block; vertical-align:right">
        <legend style="color:red" ><strong>Caller:</strong></legend>

          <label><strong>Caller Type:</strong></label>
            <select name="caller_type" id="caller_type" required>
              <option value="" selected disabled>Select...</option>
              <option value="bystander">By-Stander</option>
            ...
            <input type="text" id="caller_fname" name ="caller_fname" placeholder="Name..." size="15" />&nbsp;&nbsp;

            <label><strong>Last Name:</strong></label>&nbsp;
            <input types="text" id="caller_lname" name ="caller_lname" placeholder="Name..." size="15" /><br><br>

            <label><strong>Cell:</strong></label>
            <input type="text" id="caller_tel" name ="caller_tel" placeholder="xxx-xxx-xxxx" size="12" required />&nbsp;E.g (area code)-(first 3 digits)-(last 4 digits)
...
<!--  ------------------------------------------------------------  -->
    <fieldset>
      <legend style= "color:red"><strong>Event Location:</strong></legend>
