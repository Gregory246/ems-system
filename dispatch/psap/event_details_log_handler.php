...
//Log details to appropriate tables in the correct format of Natural/Technological/Nat_Tech 
                ...
                if($disastergroup == "tag_nat"){ echo "Natural";
                    ...
                    elseif($disastergroup == "tag_tech"){ echo "Tech";
    ...
    //Logs Caller details and assign reported disaster by that caller to their record                        

    if (!empty($_POST['caller_fname']) && !empty($_POST['caller_lname']) && !empty($_POST['caller_tel'])) {
        

        if ($_POST['caller_type'] == "victim") {

            $caller_tel = $_POST['caller_tel'];
        $caller_fname = $_POST['caller_fname'];
        $caller_lname = $_POST['caller_lname'];
        $caller_type = $_POST['caller_type'];

            $selDATA = "SELECT disaster_id FROM `disaster` WHERE user_id = '$user_id[user_id]' ORDER BY date_time DESC LIMIT 1 ";
            $selDATAquery = mysqli_query($con,$selDATA);
            $disaster_id = mysqli_fetch_assoc($selDATAquery);

           
           $insert = "INSERT INTO caller (caller_id,caller_fname,caller_lname,caller_tel,caller_type,volunteer_id,employee_id,victim_id,disaster_id)
                      VALUES (NULL,'$caller_fname','$caller_lname','$caller_tel','$caller_type',NULL,NULL,NULL,'$disaster_id[disaster_id]')";

                      mysqli_query($con,$insert);

        } elseif ($_POST['caller_type'] == "bystander") {
        ...
        } elseif ($_POST['caller_type'] == "employee") {
        ...
        $caller_type = $_POST['caller_type'];
            ...
            $selDATA1 = "SELECT employee_id FROM employees
                         WHERE MATCH(employees.employee_fname, employees.employee_lname) AGAINST('$caller_fname \n $caller_lname')";

            $query = mysqli_query($con,$selDATA1);

            $employee_id = mysqli_fetch_assoc($query);       

            
            $insert = "INSERT INTO caller (caller_id,caller_fname,caller_lname,caller_tel,caller_type,volunteer_id,employee_id,victim_id,disaster_id)
                      VALUES (NULL,'$caller_fname','$caller_lname','$caller_tel','$caller_type',NULL,'$employee_id[employee_id]',NULL,'$disaster_id[disaster_id]')";
        ...
        $caller_type = $_POST['caller_type'];
            ...
            $selDATA1 = "SELECT volunteer_id FROM volunteer
                         WHERE MATCH(volunteer.volunteer_fname, volunteer.volunteer_lname) AGAINST('$caller_fname \n $caller_lname')";

             $query = mysqli_query($con,$selDATA);

             $volunteer_id = mysqli_fetch_assoc($query);
    ...
    } elseif (!empty($_POST['caller_fname']) && empty($_POST['caller_lname']) && !empty($_POST['caller_tel'])) {
        ...
        $selDATA = "SELECT disaster_id FROM `disaster` WHERE user_id = '$user_id[user_id]' ORDER BY date_time DESC LIMIT 1 ";
           ...
           $insert = "INSERT INTO caller (caller_id,caller_fname,caller_lname,caller_tel,caller_type,volunteer_id,employee_id,victim_id,disaster_id)
                      VALUES (NULL,'$caller_fname',NULL,'$caller_tel','$caller_type',NULL,NULL,NULL,'$disaster_id[disaster_id]')";
        ...
        $selDATA = "SELECT disaster_id FROM `disaster` WHERE user_id = '$user_id[user_id]' ORDER BY date_time DESC LIMIT 1 ";
           ...
           $insert = "INSERT INTO caller (caller_id,caller_fname,caller_lname,caller_tel,caller_type,volunteer_id,employee_id,victim_id,disaster_id)
                      VALUES (NULL,NULL,'$caller_lname','$caller_tel','$caller_type',NULL,NULL,NULL,'$disaster_id[disaster_id]')";
        ...
        $selDATA = "SELECT disaster_id FROM `disaster` WHERE user_id = '$user_id[user_id]' ORDER BY date_time DESC LIMIT 1 ";
           ...
           $insert = "INSERT INTO caller (caller_id,caller_fname,caller_lname,caller_tel,caller_type,volunteer_id,employee_id,victim_id,disaster_id)
                      VALUES (NULL,NULL,NULL,'$caller_tel','$caller_type',NULL,NULL,NULL,'$disaster_id[disaster_id]')";

                      mysqli_query($con,$insert);
    }

                            header("Location: http://$host/ems/dispatch/psap/event-record.php");
                            exit();
