...
<!-- Sidenav -->
              ...
              <h4 style = "font-size: 190%"><b>Search by:</b></h4>
                  <a href="\EMS\dispatch\psap\event-queries-location.php" class="w3-hover-black" style = "font-size:150%">Location</a>
                  <a href="\EMS\dispatch\psap\event-queries-disaster.php" class="w3-hover-black" style = "font-size:150%">Disaster</a>
                  <a href="\EMS\dispatch\psap\event-queries-date.php" class="w3-hover-black" style = "font-size:150%">Date</a>
                  <a href="\EMS\dispatch\psap\event-queries-informant.php" class="w3-hover-black" style = "font-size:150%">Informant</a>
              </nav>
