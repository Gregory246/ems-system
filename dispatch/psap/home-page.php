...
<button id="myButton" class="submit" style="width:150px; height:100px;" ><strong>Log Record</strong><br>(New Event)</button>
<button id="myButton1" class="submit" style="width:150px; height:100px;" ><strong>Confirm Event</strong><br>(Details)</button>
<button id="myButton2" class="submit" style="width:150px; height:100px;" ><strong>Search Record(s)</strong><br>(###)</button>
<button id="myButton3" class="submit" style="width:150px; height:100px;" ><strong>View Notices</strong><br>(Updates)</button>
...
<script type="text/javascript">
    document.getElementById("myButton1").onclick = function () {
        location.href = "event-confirm.php";
    };
</script>
