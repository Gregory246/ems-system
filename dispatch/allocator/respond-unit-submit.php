...
<?php   
		...
		$vehcileteam_id = $_POST['vehcileteam_id'];
		$employee_id = $_POST['employee_id'];
		$disaster_id = $_POST['disaster_id'];
    date_default_timezone_set("Etc/GMT+4");

	$insert = "INSERT INTO `ems_response` (`ems_response_id`, `vehicleteam_id`, `first_response`, `arrived`, `employee_id`,`disaster_id`) 
				VALUES (NULL, '$vehcileteam_id', '$first_response', '0', '$employee_id', '$disaster_id')";
