...
<div class="w3-main" style="margin-top:250px">
 ...
 <div align = "center">
  ...
  <button id="myButton" style="height:30px;" onclick="suppliesRequired()"><strong>Medical Supplies Required</strong></button>
  <button id="myButton1" style="height:30px;" onclick="pharmaceuticalsRequired()"><strong>Pharmaceuticals Required</strong></button>
<br>

<p><strong><span style = 'color:red'>Select one of the buttons to obtain required resources.</span></strong></p>
...
<script type="text/javascript">
      ...
      xmlhttp.open("GET","medical-supplies-required.php",true);
      xmlhttp.send();
...
<script type="text/javascript">
          ...
          function pharmaceuticalsRequired(){
      ...
      xmlhttp.open("GET","pharmaceuticals-required.php",true);
      xmlhttp.send();
  }
