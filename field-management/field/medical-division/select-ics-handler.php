...
$select = "SELECT * 
			...
			AND `ics_branches`.`branch` LIKE '%Manager%'
            OR `ics_branches`.`branch` LIKE '%Leader%'
            OR `ics_branches`.`branch` LIKE '%Personnel%'
            OR `ics_branches`.`branch` LIKE '%Supply%'
            ORDER BY `ics_branches`.`branch` ASC";
