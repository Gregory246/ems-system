...
//}
      ...
      $select = "SELECT disaster.*,location.*, CONCAT(location.addressline1,' ',location.addressline2,' ',location.city,' ',location.locality,' ',location.country)location, disaster_location.*,disastertype.*
...
<form method="POST" action="get-disaster-id.php">
 <fieldset>
  <legend><strong>Disaster and Location:</strong></legend>
    <br>
      <table id = 'mytable' border = 1>
        <tr>
         <th>Disaster and Location:</th>
        </tr>
        <tr>
           <td>
            <select id="location" name="location" required>
              ...
              <option value"<?=$disaster['location'];?>"><?php echo "\n"."Disaster:"."\n".$disaster['disaster_type']."\n"."Location:"."\n"."\n"."\n"."\n". $disaster['location'];?></option>
            <?php endwhile;?>
            </select>
          </td>
        </tr>
...
xmlhttp.open("GET","get-disaster-id.php?location="+location,true);
      xmlhttp.send();
      window.close(); }
  }
