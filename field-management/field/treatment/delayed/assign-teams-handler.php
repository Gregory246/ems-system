...
$select4 = "SELECT employees.*, users.username 
	...
	$select1 = "SELECT * FROM victim WHERE victim.medical_triage_tag = 'DELAYED' AND victim.disaster_id = '70' AND victim.treatment_personnel IS NULL"; //Remove dummy value 
