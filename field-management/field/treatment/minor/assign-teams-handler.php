...
$select4 = "SELECT employees.*, users.username 
	...
	$select1 = "SELECT * FROM victim WHERE victim.medical_triage_tag = 'MINOR' AND victim.disaster_id = '$disaster_id' AND victim.treatment_personnel IS NULL"; //Remove dummy value 
  	...
  	$select2 = "SELECT * FROM victim WHERE victim.medical_triage_tag = 'MINOR' AND victim.disaster_id = '$disaster_id' AND victim.treatment_personnel IS NOT NULL AND victim.treatment_received = 1"; //Remove dummy value
