...
$select_dispatch = "SELECT agency.agency_name,department.department_name, IFNULL(department.department_fax,'~')department_fax,
        employees.employee_fname,employees.employee_lname, employees.user_id,CONCAT(employees.employee_fname,' ', employees.employee_lname)employee_name
        ...
        JOIN agency ON department.agency_id = agency.agency_id WHERE employees.employee_title = 'Telephone Dispatcher'";

                $query0 = mysqli_query($con,$select_dispatch);

                //$operator = mysqli_fetch_assoc($query0);
...
<!DOCTYPE html>
  ...
  function showEmployees(){
    ...
    if(agency == ""){
      ...
      document.getElementById("test1").innerHTML = "Please select Telephone Dispatcher!";
      return;
    }
...
<link rel="shortcut icon" href="\phone\phone\favicon.ico"/>
...
<div class="w3-main" style= "text-align:center" >
    ...
    <body onload="startTime()" style="text-align: center; background: url('\Phone\webphone\images\body_bg.png') repeat #ededed;">
        <!--Banner top of web-->
                    ...
                    <!-- <label>Disaster Group:</label>
                     ...
                     <div align="center">
                         <fieldset style = "display:inline-block">
                              ...
                              <label><strong>Telephone Dispatch<strong></strong>:</strong></label>
                                  <select name="agency" id = "agency" required>
                                    <option value="" >Select</option>
                                    <?php while ($row2 = mysqli_fetch_assoc($query0)):;?>

                                     <option><?php echo $row2['employee_name']; ?></option>
                                      <?php endwhile;?>
                                     </select>
...
<iframe frameborder="0" width="300" height="400" src="\Phone\webphone\softphone.html" name="wphone" id="webphoneframe" style="z-index: 1000"></iframe>
